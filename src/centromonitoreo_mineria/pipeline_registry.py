...
from centromonitoreo_mineria.pipelines.analyze_sentinel2_pca.pipeline import (
    create_pipeline as analyze_sentinel2_pca_pipeline,
)
...
from centromonitoreo_mineria.pipelines.extract_sentinel2_training_features.pipeline import (
    create_pipeline as extract_sentinel2_training_features_pipeline,
)
...
from centromonitoreo_mineria.pipelines.postprocess_mining_binary_map.pipeline import (
    create_pipeline as postprocess_mining_binary_map_pipeline,
)
from centromonitoreo_mineria.pipelines.predict_mining_binary_map.pipeline import (
    create_pipeline as predict_mining_binary_map_pipeline,
)
