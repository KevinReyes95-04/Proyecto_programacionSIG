...
from centromonitoreo_mineria.pipelines.postprocess_mining_multiclass_map.pipeline import (create_pipeline as postprocess_mining_multiclass_map_pipeline)
...
from centromonitoreo_mineria.pipelines.predict_mining_multiclass_map.pipeline import (create_pipeline as predict_mining_multiclass_map_pipeline)
...
from centromonitoreo_mineria.pipelines.train_mining_multiclass_rf.pipeline import (create_pipeline as train_mining_multiclass_rf_pipeline)
...
from centromonitoreo_mineria.pipelines.validate_mining_multiclass_map.pipeline import (create_pipeline as validate_mining_multiclass_map_pipeline)
from centromonitoreo_mineria.pipelines.validate_postprocessed_mining_multiclass_map.pipeline import (create_pipeline as validate_postprocessed_mining_multiclass_map_pipeline)
