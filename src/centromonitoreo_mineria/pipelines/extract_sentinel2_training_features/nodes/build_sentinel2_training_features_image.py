...
from centromonitoreo_mineria.pipelines.helper.google_earth_engine.topographic_features import add_topographic_features


# Funcion para construir la imagen Sentinel-2 con indices y topografia.
def build_sentinel2_training_features_image(config: dict) -> Any:
    ...
    return add_topographic_features(
        image=indices_image,
        params=config["sentinel2_training_features"].get("topographic_features", {}),
    )
